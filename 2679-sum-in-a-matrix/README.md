...
<pre style="position: relative;"><strong>Input:</strong> nums = [[7,2,1],[6,4,2],[6,5,3],[3,2,1]]
...
<strong>Explanation:</strong> We remove 1 and add it to the answer. We return 1.<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>
